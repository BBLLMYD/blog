...
| **Attention** <br>自注意力机制，主要负责捕捉上下文关联 | 信息交互效率、长文本能力 | **共享KV头减少GPU占用并加速推理**<br> **局部注意力如滑动窗口**<br> **线性注意力降低复杂度**<br>**系统层感知硬件优化IO**       | 降低KVCache的显存占用，并将计算复杂度从指数级别降低到近线性                      |
...
| **Norm** <br> 归一化，主要负责稳定数值分布         | 训练稳定性        | **变体替换**                                                                             | 解决不稳定性如梯度消失和爆炸                                         |
