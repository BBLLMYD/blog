...
| Norm归一化         | 负责稳定数值分布      | 训练稳定性        | 替换变体                                                                                                                                                                                                                                                | 解决不稳定性如梯度消失和爆炸                                         |
| 稀疏化             | /             | 高效扩大有效参数量    | 混合专家模型                                                                                                                                                                                                                                              | 打破了算力与参数量强绑定的限制，在不增加推理/训练的情况下能成倍/十倍规模的扩大模型的总参数量来捕获更多知识 |
...
历史一定是持续迭代的，观点也不是非黑即白，总有先行者不断突破世界的边界。Transformer或许是目前为止适配性最好的终极答案，更可能是未来无限可能中的里程碑之一。