...
|:--------------|:-------------|:-------------------------------------------------------------------------------------|:-------------------------------------------------------|
| **架构形态**      | 任务范式适配       | **Encoder-Only适合理解类任务** <br> **Decoder-Only适合生成类任务** <br> **Encoder-Decoder序列到序列任务** | 根据具体任务（如分类、翻译、对话）选择最高效适合的范式。Decoder-Only已成为大模型的主流选择    |
| **Attention** | 信息交互效率、长文本能力 | **共享KV头减少GPU占用并加速推理**<br> **局部注意力如滑动窗口**<br> **线性注意力降低复杂度**<br>**系统层感知硬件优化IO**       | 降低KVCache的显存占用，并将计算复杂度从指数级别降低到近线性                      |
| **Position**  | 顺序表达、长度扩散能力  | **绝对位置编码**<br>**相对位置编码**<br>**旋转位置编码**                                               | 解决模型性能问题，旋转位置编码目前兼顾了绝对和相对位置优势。                         |
