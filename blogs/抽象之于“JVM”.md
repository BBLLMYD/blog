...
所以JVM本身其实也理解成一个抽象的概念，可以说是一个**负责解释编译满足规范的字节码**平台。
...
也正是JVM的存在，降低了语言本身的使用门槛，得以让Java这种高级语言更普适，
让语言本身更好的普及。这种好处最开始是以相对牺牲一些性能作为代价，
而JVM平台发展了到了今天，性能上已经不输于原来的C/C++了，
甚至一些场景下已经可以做到领先。

2/8定律来看，我们的一个进程内的程序的跑的最多的热点代码往往只占大约20%，
而这部分热点代码可能占了80%的资源。
...
- [7. 其他 & 总结](https://github.com/BBLLMYD/blog/blob/master/%E6%8A%BD%E8%B1%A1%E4%B9%8B%E4%BA%8E%E2%80%9CJVM%E2%80%9D.md#5%E5%85%B3%E4%BA%8E%E5%A4%84%E7%90%86%E5%B7%A5%E5%85%B7)
