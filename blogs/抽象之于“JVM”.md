...
GCRoots 是判断对象可达性根基，GCRoots大类包括：
...
<div align=center><img src="https://github.com/BBLLMYD/blog/blob/master/images/02/2-13.png?raw=true" width="444"></div>
    ...
    无论哪种收集器本质上都是对资源的管理，根据应用特性来Match才是合理的。
...
要想知道JVM“全部的真相”可能离不开源码。JVM是个大工程，虽然架构清晰，但也有很多的细枝末节。

作为JVM语言的用户，了解JVM设计的一些方向，和相关的具体实现，这样也可以得到“相对的自由”。
